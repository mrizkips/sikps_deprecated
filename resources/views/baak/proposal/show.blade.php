                ...
                <div class="card card-accent-primary">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="float-right">
                            @include('components.proposal.approve', ['id' => $proposal->id, 'url' => route('baak.proposal.approval', $proposal->id)])
                            @include('components.proposal.disapprove', ['id' => $proposal->id, 'url' => route('baak.proposal.approval', $proposal->id)])
                        </div>
                    </div>
                </div>
            </div>
