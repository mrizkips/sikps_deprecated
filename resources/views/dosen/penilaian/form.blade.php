...
@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('dosen.pengujian.show', $pengujian->id) }}">Pengujian</a></li>
...
<div class="container-fluid">
    <div class="fade-in">
        ...
        <form class="form-horizontal" action="{{ isset($penilaian) ? route('dosen.penilaian.update', ['penilaian' => $penilaian, 'pengujian' => $pengujian]) : route('dosen.penilaian.store', $pengujian) }}" method="post">
            @csrf
                ...
                <div class="col-md-10">
                    <div class="card card-accent-primary">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('dosen.pengujian.show', $pengujian) }}" class="btn btn-secondary"><i class="cil-arrow-thick-left"></i> Kembali</a>
