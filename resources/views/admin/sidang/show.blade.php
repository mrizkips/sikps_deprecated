            ...
            <div class="col-md-10">
                <div class="card card-accent-primary">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('admin.sidang.index') }}" class="btn btn-secondary"><i class="cil-arrow-thick-left"></i> Kembali</a>
                        <div class="float-right">
                            @include('components.sidang.approve', ['id' => $sidang->id, 'url' => route('admin.sidang.approval', $sidang->id)])
                            @include('components.sidang.disapprove', ['id' => $sidang->id, 'url' => route('admin.sidang.approval', $sidang->id)])
                        </div>
                    </div>
                </div>
            </div>
