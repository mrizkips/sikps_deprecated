...
@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('admin.bimbingan.index') }}">Bimbingan</a></li>
            ...
            <div class="col-md-10">
                <div class="card card-accent-primary">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('admin.bimbingan.index') }}" class="btn btn-secondary"><i class="cil-arrow-thick-left"></i> Kembali</a>
                    </div>
                </div>
            </div>
        </div>
