<div class="form-group row">
    ...
    <div class="col-md">
        @include('components.input', [
            'type' => 'text',
            'name' => 'nama',
            'value' => isset($keuangan) ? $keuangan->user->nama : old('nama'),
            'required' => false,
            'autofocus' => true,
    ...
    <div class="col-md">
        <select name="jen_kel" id="jen_kel" class="form-control @error('jen_kel') is-invalid @enderror">
            ...
            @foreach (config('constant.jen_kel') as $item)
                <option value="{{ $item }}" {{ isset($keuangan) ? ($keuangan->jen_kel == $item ? 'selected' : '') : '' }}>{{ $item }}</option>
            @endforeach
        </select>
        @error('jen_kel')
...
<div class="form-group row">
    ...
    <div class="col-md">
        @include('components.input', [
            'type' => 'email',
            'name' => 'email',
            'value' => isset($keuangan) ? $keuangan->user->email : old('email'),
            'required' => false,
            'autofocus' => false,
...
<div class="form-group row">
    ...
    <div class="col-md">
        @include('components.input', [
            'type' => 'text',
            'name' => 'nip',
            'value' => isset($keuangan) ? $keuangan->nip : old('nip'),
            'required' => false,
            'autofocus' => false,
...
<div class="form-group row">
    ...
    <div class="col-md">
        @include('components.input', [
            'type' => 'number',
            'name' => 'no_hp',
            'value' => isset($keuangan) ? $keuangan->no_hp : old('no_hp'),
            'required' => false,
            'autofocus' => false,
