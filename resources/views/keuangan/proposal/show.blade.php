...
<div class="modal fade" id="disapproveModal" tabindex="-1" role="dialog" aria-labelledby="disapproveModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('keuangan.proposal.approval', $proposal->id) }}" method="post" class="float-right mr-1" onsubmit="return confirm('Apakah Anda yakin akan melakukan aksi ini?');">
