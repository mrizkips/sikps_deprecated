...
class PenilaianController extends Controller
{
    ...
    public function create(Pengujian $pengujian, PengujianService $service)
    {
        ...
        if ($count > 0) {
            return redirect()->route('dosen.pengujian.show', $pengujian)->with('flash_messages', [
                'type' => 'warning',
                'message' => trans('penilaian.messages.errors.is_existed'),
            ]);
        }

        return view('dosen.penilaian.form', compact('form_penilaian', 'pengujian'));
    }
    ...
    {
        return view('dosen.penilaian.show', compact('pengujian', 'penilaian'));
    }
    ...
    {
        $form_penilaian = $service->checkFormPenilaian(auth()->user(), $pengujian);
        return view('dosen.penilaian.form', compact('form_penilaian', 'pengujian', 'penilaian'));
    }
